...
public:
	...
	{
		auto& bucket_list = buckets[GetBucketIndex(value)];
		auto it = std::find(bucket_list.begin(), bucket_list.end(), value);
	...
	{
		auto& bucket_list = buckets[GetBucketIndex(value)];
		return std::find(bucket_list.begin(), bucket_list.end(), value) != bucket_list.end();
	}
